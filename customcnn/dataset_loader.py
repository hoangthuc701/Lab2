...
def load_cifar100_datasets(data_dir, batch_size=4, num_workers=2, augment=True, val_split=0):
    ...
    # Use pin_memory=True for CUDA, num_workers=0 for validation to avoid hanging
