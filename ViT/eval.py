import os
import torch
from model_vit import build_vit_b16  # Đổi sang hàm cho ViT
...
def evaluate_all_models(tuning_hyperparameters):
    ...
    model_dir = "vit/models"  # Đổi folder model
    ...
    for file in os.listdir(model_dir):
        if tuning_hyperparameters in file and file.endswith(".pth"):
            ...
            # Load model
            model = build_vit_b16(num_classes=100, pretrained=False).to(device)
